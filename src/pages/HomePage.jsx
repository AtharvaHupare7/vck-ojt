         ...
         <>
            ...
            <div className="main-wrapper"> {/* Uses shared class */}
                <div className="main-box"> {/* Uses shared class */}
                    ...
                    <div className="main-content-scrollable"> {/* Uses shared class */}
                        ...
                        <div className="campus-images-container">
                            ...
                            <img src="../Images/students-studying-DbLGuwF_.jpeg" alt="Vivekanand College Campus" className="campus-image"/>
                        </div>
                    </div>
                </div>
            </div>
